...
var decompressor = (
    'function(r){function n(n){for(var o=0,f=1;f!=n;){var t=a&m;m>>=1,0==m&' +
    '&(m=32,a=c[r[S++]]),o|=t&&f,f<<=1}return o}function o(r){e[C++]=r,v--,' +
    'v||(v=1<<d,d++)}function f(){var r=n(1<<d);return 2>r&&(o(i(n(1<<8*r+8' +
    '))),r=C-1),r}for(var t,u,a,i=String.fromCharCode,c={},e=[,,""],v=1,C=3' +
    ',d=2,g="",h=64,m=32,S=1;--h>=0;)c[i(h>61?4*(1&h)|43:h+[65,71,-4][h/26&' +
    '3])]=h;for(a=c[r[0]],t=e[f()];t;)g+=t,u=t,h=f(),t=h==C?u+u[0]:e[h],o(u' +
    '+t[0]);return g}' /* end */
);
